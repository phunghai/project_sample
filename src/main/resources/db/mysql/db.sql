...
INSERT INTO `m_province` VALUES ('01','01','Hà Nội','Ha Noi','2020-02-20 15:40:30','2020-02-20 15:40:30'),('02','01','Tp Hồ Chí Minh','Ho Chi Minh','2020-02-20 15:41:45','2020-02-20 15:41:45');
...
CREATE TABLE `province_plates` (
  ...
  `vehicle_plates_id` bigint(11) unsigned DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `province_plates` VALUES (1,'01','50',2,NULL,NULL),(2,'02','51',2,NULL,NULL),(3,'01','29',1,NULL,NULL),(4,'02','30',1,NULL,NULL);
...
INSERT INTO `vehicle_registration_plates` VALUES (1,'01',1,NULL,NULL),(2,'02',1,NULL,NULL);
...
-- Dump completed on 2020-02-21 10:27:09
